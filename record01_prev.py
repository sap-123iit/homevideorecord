...
def call_videoupload():
    """Call videoupload.py script."""
    try:
        subprocess.run(["python3", "videoupload.py"], check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
        print("Successfully called videoupload.py")
    except Exception as e:
        print(f"Error calling videoupload.py: {e}")
...
def record_and_stitch():
    ...
    while True:
        ...
        # Check if 20 minutes have passed to call videoupload.py
